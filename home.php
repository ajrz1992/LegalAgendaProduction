...
<div class="row">
  ...
  <div class="col-12 col-sm-6 col-md-4 evaluadores">
    <div class="small-box bg-light shadow-sm border">
      <div class="inner">
        <h3><?php $empresa=$_SESSION['login_empresa']; echo $conn->query("SELECT * FROM evaluator_list where empresa='$empresa'")->num_rows; ?></h3>
...
<script>
  $('.departamentos').dblclick(function(){
   ...
   $('.empleados').dblclick(function(){
     ...
     $('.evaluadores').dblclick(function(){
		window.location.href = 'https://demolegalagenda.tecnologiainnovacion.com/index.php?page=evaluator_list';
	})
</script>
<?php else: ?>
   <div class="col-12">
