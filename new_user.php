				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<!-- name="cpass" -->
							<input type="password" id="passwordInput2" class="form-control form-control-sm" <?php echo !isset($id) ? 'required' : '' ?>>
...
togglePasswordButton.addEventListener("click", function() {
	...
	$('[name="password"],[id="passwordInput2"]').keyup(function(){
		var pass = $('[name="password"]').val()
		var cpass = $('[id="passwordInput2"]').val()
		if(cpass == '' ||pass == ''){
