...
<img src="assets/uploads/flecha.gif"  id="regresarCalendario"><b>Regresar al Calendario</b></img>
<img src="assets/uploads/flecha.gif"  id="carpetaRaiz"><b>Regresar al Carpeta Raiz</b></img>
<h1>
<?php 
...
<div class="card card-outline card-success">
		...
		<div class="row tarealist">
			<?php
				$i = 1;
				$where = " where t.empresa='{$_SESSION['login_empresa']}' and t.seleccionado=1 and t.id=(SELECT buscador from buscador)"; 
				if($_SESSION['login_type'] == 0)
					$where = " where t.employee_id = '{$_SESSION['login_id']}' and t.empresa='{$_SESSION['login_empresa']}' and t.id=(SELECT buscador from buscador)";
				elseif($_SESSION['login_type'] == 1)
					$where = " where e.evaluator_id = {$_SESSION['login_id']} and e.empresa='{$_SESSION['login_empresa']}' and t.id=(SELECT buscador from buscador)";
...
<div class="card" style="width: 18rem;" data-nombre="<?php echo ucwords($row['task']) ?>">
							...
							<i class="fas fa-cogs"></i>
			                    ...
			                    <div class="dropdown-menu" style="">
									...
									<div class="dropdown-divider"></div>
									<a class="dropdown-item copiar" data-id="<?php echo $row['id'] ?>" style="display:none">Copiar a...</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item mover" data-id="<?php echo $row['id'] ?>">Mover a...</a>
									<div class="dropdown-divider"></div>
									<?php if($_SESSION['login_type'] == 2): ?>
  ...
  if (event.key === "Escape") {
	...
	$(document).ready(function(){
		...
		$('#regresarCalendario').click(function(){
			window.location.href = 'https://demolegalagenda.tecnologiainnovacion.com/index.php?page=calendario';
		})
