					...
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<select name="department_id" id="department_id" class="form-control form-control-sm select2">
								...
								$departments = $conn->query("SELECT * FROM department_list WHERE empresa='$empresa' order by department asc");
						...
						<div class="form-group">
							...
							<select name="designation_id" id="designation_id" class="form-control form-control-sm select2">
								...
								<?php 
								$empresa=$_SESSION['login_empresa'];
								$designations = $conn->query("SELECT * FROM designation_list WHERE empresa='$empresa' order by designation asc");
						...
						<div class="form-group">
							...
							<select name="evaluator_id" id="evaluator_id" class="form-control form-control-sm select2">
								...
								<?php 
								$empresa=$_SESSION['login_empresa'];
								$evaluators = $conn->query("SELECT *,concat(lastname,', ',firstname,' ',middlename) as name FROM evaluator_list WHERE empresa='$empresa' order by concat(lastname,', ',firstname,' ',middlename) asc");
