					...
					<div class="col-md-6 border-right">
						<div class="form-group">
							...
							<select name="employee_id" id="employee_id" class="form-control form-control-sm select2">
								...
								$employees = $conn->query("SELECT *,concat(lastname,', ',firstname,' ',middlename) as name FROM employee_list where evaluator_id = {$_SESSION['login_id']} and empresa='$empresa' order by concat(lastname,', ',firstname,' ',middlename) asc");
